...
import 'login_page.dart'; // Assuming you have a login page to redirect after successful verification
...
class SignUpVerificationPage extends GetView<SignUpVerificationController> {
  final String email;

  SignUpVerificationPage({Key? key, required this.email}) : super(key: key) {
    Get.put(SignUpVerificationController(email));
  }
